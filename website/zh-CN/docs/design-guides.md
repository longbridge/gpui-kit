...
<img class="alignment-light" src="/radius-hierarchy.svg" alt="浅色主题的聊天输入框：内缩表面、两侧按钮及提示文字的间距一起变化；红色参考圆显示转角共用圆心。">
<img class="alignment-dark" src="/radius-hierarchy-dark.svg" alt="深色主题的聊天输入框：内缩表面、两侧按钮及提示文字的间距一起变化；红色参考圆显示转角共用圆心。">
