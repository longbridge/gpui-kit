...
pub use text::{
    ...
    MarkdownPlugin, RangeHighlight, RangeHighlightError, RenderedTextSnapshot, SelectionFormat,
    TableData, Text, TextView, TextViewDefaults, TextViewMotion, TextViewPlugin, TextViewState,
    TextViewStyle, html, markdown, markdown_ast,
};
