...
/// The height of a menu item: iOS's edit menu row, a little under its
/// 44pt touch minimum, which the bar's own edges make up for.
            ...
            let button = div()
                ...
                .child(
                    Button::new(ix)
                        ...
                        // row, with body text and room on both sides.
                        .large()
                        .h(ROW_HEIGHT)
                        .px_3()
                        .rounded(radius)
